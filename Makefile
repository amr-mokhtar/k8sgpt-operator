...
IMG ?= ghcr.io/k8sgpt-ai/k8sgpt-operator:1.0
...
docker-build: test ## Build docker image with the manager.
	...
	sudo docker buildx build --build-arg=VERSION="$$(git describe --tags --abbrev=0)" --build-arg=COMMIT="$$(git rev-parse --short HEAD)" --build-arg DATE="$$(date +%FT%TZ)" --platform="linux/amd64" -t ${IMG} .
